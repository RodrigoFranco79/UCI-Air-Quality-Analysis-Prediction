Please use the AirQualityUCI_EDA_R.csv dataset and
compute using following R script: Quality UCI GT Analysis.R.

Dependency: Library openair

Comment: I computet and plotted in R Studio CLoud

Air Quality UCI GT Analaysis.R
